...
{
    public class LockMainTargetState:ShipIdleState
    {
        ...
        public LockMainTargetState(ShipStateMachine stateMachine) : base(stateMachine)
        {
            moveModel = model.GetModelObserver<IShipMoveModelObserver>();
            weaponModel = model.GetModelObserver<IWeaponModelObserver>();
        }

        public void SetData(IShipUnitsProvider mainTarget, Vector3 targetPosition)
        {
